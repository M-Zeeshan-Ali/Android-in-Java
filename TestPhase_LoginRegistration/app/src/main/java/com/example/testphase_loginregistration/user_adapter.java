...
public class user_adapter extends RecyclerView.Adapter<user_adapter.ViewHolder>{
    ...
    public user_adapter(Context mctx, List<user_class> user_classes) {
        this.mctx = mctx;
    ...
    public void onBindViewHolder(@NonNull user_adapter.ViewHolder holder, int position) {
        ...
        holder.accept.setOnClickListener(new View.OnClickListener() {
            ...
            Log.d("",""+linkapi.url+"accept.php?id="+userlass.getId()+"");
                JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, linkapi.url + "accept.php?id=" + userlass.getId() + ""
                        , null,
                            ...
                            public void onResponse(JSONObject response) {
                                try{
                                    ...
                                    if(res.equals("true"))
                                    {
                                        ...
                                        Intent intent=new Intent(mctx,User_Details.class);
