...
public class bus_adapter extends RecyclerView.Adapter<bus_adapter.ViewHolder> {
    ...
    bus_adapter(Context mctx, List<bus_class> bus_classes)
    {
...
//Data Binding of bus_adapter
    @NonNull
    @Override
    public bus_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(mctx);
        View view=layoutInflater.inflate(R.layout.layout_bus_name,null);

        return new bus_adapter.ViewHolder(view);
    }
    //Data Binding of viewholder with the help of adapter class "and show its position where the last bus "
    @Override
    public void onBindViewHolder(@NonNull bus_adapter.ViewHolder holder, int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("",""+linkapi.url + "del_bus.php?name="+busClass.getName()+"");
                JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, linkapi.url + "del_bus.php?name="+busClass.getName()+"", null,
                            ...
                            public void onResponse(JSONObject response) {
                                try
                                {
                                    ...
                                    if(res.equals("true"))          //if condition is true then intent class declared
                                    {
                                        ...
                                        Intent intent=new Intent(mctx,bus_details.class);
...
//data binding
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        AppCompatButton delete;     //appcompatButton is object to declare the varialbe delete to delete from app and database record
        public ViewHolder(@NonNull View itemView) {
            ...
            delete=itemView.findViewById(R.id.delete);  //delete variable is set (itemview.findviewby id and xml assign id "delete".
