        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(TextUtils.isEmpty(phone))
                {
                    ...
                    Log.d("",""+linkapi.url+"user_register.php?name="+na+"&email="+em+"&password="+pass+"&phone="+phone+"&cnic="+cni+ "&gender=" + getgender +"");
                    JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(
                            Request.Method.GET,
                            linkapi.url+"user_register.php?name="+na+"&email="+em+"&password="+pass+"&phone="+phone+"&cnic="+cni+ "&gender=" + getgender +"",
                            null,
