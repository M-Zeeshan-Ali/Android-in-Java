            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(mctx, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, linkapi.url + "addbooking.php?email="+user_login.passemail+"&bname="+busClass.getName()+"&sr="+user_home.saddress+
                                "&er="+user_home.eaddress+"&date="+d+"", null,
...
//data binding
    ...
    public int getItemCount() {
        return bus_classes.size();
                        ...
                        //in parent RecyclerView i get the property of ViewHolder
