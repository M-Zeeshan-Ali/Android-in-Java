...
public class admin_dashboard extends AppCompatActivity {
    ...
    AppCompatButton btncity,btnroute,btnuser,btnlogout,btnbus; //variable names of dashboard button
...
btnbus.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
         ...
         */
        Intent z=new Intent(admin_dashboard.this,bus_details.class);
        startActivity(z);
    }
});
